...
export default function SocialHub() {
  const links = [
    {
      ...
      handle: '@callmediya',
      role: 'Minecraft & Streaming',
      url: 'https://youtube.com/@callmediya',
      color: '#ef4444',
      icon: (
    ...
    {
      platform: 'YouTube Muzyka',
      handle: '@DiyaIRL',
      role: 'Folk, Wokal & Utwory',
  ...
  return (
    <section id="linki" className="section" aria-label="Wszystkie Oficjalne Linki i Social Media">
      <div className="container">
        <div className="section-header">
          <span className="section-tag">Wszystkie Kanały</span>
          <h2 className="section-title">Oficjalne Linki Społecznościowe</h2>
          <p className="section-subtitle">
            Bądź na bieżąco z premierami filmów, muzyką, transmisjami oraz życiem społeczności.
          </p>
        </div>
        ...
        <div className="social-links-grid">
          {links.map((item, idx) => (
            ...
            >
              ...
              <span className="social-badge">{item.role}</span>
            </a>
          ))}
        </div>
      </div>
